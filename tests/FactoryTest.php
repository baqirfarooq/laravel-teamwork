...
use Mockery as m;
use Baqirfarooq\Teamwork\Factory;
...
class FactoryTest extends PHPUnit_Framework_TestCase {
    ...
    {
        parent::setUp();
        $this->requestable = m::mock('Baqirfarooq\Teamwork\Contracts\RequestableInterface');
    }
    ...
    public function test_that_it_returns_new_account_object()
    {
        ...
        $this->assertInstanceOf('Baqirfarooq\Teamwork\Account', $factory->account());
    }

    /**
     * @group factory
     * @expectedException Baqirfarooq\Teamwork\Exceptions\ClassNotCreatedException
     */
